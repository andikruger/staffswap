...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://lucky-red-robe.cyclic.app:8000/api/v1/user/username/${uuid}`
      )
      .then((res) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (!userExists) {
        axios
          .post(
            "https://lucky-red-robe.cyclic.app:8000/api/v1/user/register",
            submitObject
          )
          .then((res) => {
        ...
        axios
          .put(
            `https://lucky-red-robe.cyclic.app:8000/api/v1/user/update/${user._id}`,
            submitObject
          )
          .then((res) => {
            toast.success("Profile updated successfully", {
